...
var websocketclient = {
	...
	connect: function () {
		...
		var port = 8000;
		var clientId = "clientId-HRkGhNuxn2";
		var keepAlive = 60;
	...
	render: {
		...
		message: function (message) {
			...
			var html =
				'<li class="messLine id="' +
				largest +
				'">' +
				'   <div class="row large-12 mess' +
				largest +
				'" style="border-left: solid 10px #' +
				message.color +
				'; ">' +
				...
				"</div>" +
				'           <div class="large-5 columns topicM truncate" id="topicM' +
				largest +
				'" title="' +
				Encoder.htmlEncode(message.topic, 0) +
				'">Topic: ' +
				Encoder.htmlEncode(message.topic) +
				"</div>" +
				'           <div class="large-2 columns qos">Qos: ' +
				message.qos +
				"</div>" +
			...
			html +=
				"           </div>" +
				'           <div class="large-12 columns message break-words">' +
		...
		subscription: function (subscription) {
			...
			$("#innerEdit").append(
				'<li class="subLine" id="sub' +
					largest +
					'">' +
					'   <div class="row large-12 subs' +
					largest +
					'" style="border-left: solid 10px #' +
					subscription.color +
					...
					'              <a href="#" onclick="websocketclient.deleteSubscription(' +
					largest +
					'); return false;">x</a>' +
					"           </div>" +
					'           <div class="qos">Qos: ' +
					subscription.qos +
					"</div>" +
					'           <div class="topic truncate" id="topic' +
					largest +
					'" title="' +
					Encoder.htmlEncode(subscription.topic, 0) +
					'">' +
		...
		removeSubscriptionsMessages: function (id) {
			websocketclient.messages = _.filter(
				websocketclient.messages,
				function (item) {
